...
function workflow(overrides: Partial<Workflow> = {}): Workflow {
  return {
    ...
    description: '',
    labels: [
      { id: 'l1', workflow_id: 'wf1', name: 'review', color: '#000', sort_order: 0, agent_ignore: 1, is_terminal: 0, create_pr: 0, wip_limit: null, wip_limit_hard: 0 },
      { id: 'l2', workflow_id: 'wf1', name: 'done', color: '#000', sort_order: 1, agent_ignore: 0, is_terminal: 1, create_pr: 0, wip_limit: null, wip_limit_hard: 0 },
    ],
    transitions: [],
    created_at: '',
    updated_at: '',
